...
(PERMISSION_TYPE, TARGET, VALUE__, ROLE_ID, VERSION, UPDATE_TS, UPDATED_BY, DELETE_TS, DELETED_BY, ID, CREATE_TS, CREATED_BY)
...
insert into SEC_PERMISSION
(PERMISSION_TYPE, TARGET, VALUE_, ROLE_ID, VERSION, UPDATE_TS, UPDATED_BY, DELETE_TS, DELETED_BY, ID, CREATE_TS, CREATED_BY)
